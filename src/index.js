...
function generateAnswer(event){
  ...
  let context =
    "You are an seasoned chef with expertise in cooking various dishes.Your task is to generate a  simple , beginner-friendly  , short recipe in no more than 8 lines.Use basi HTML , separating each step with a <br> tag and skip two lines afer the recipe , and  sign off with a <strong> Byte-Bites🍳";
